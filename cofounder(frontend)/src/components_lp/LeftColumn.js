    ...
    <div className="h-screen items-center bg-black mt-5 text-white">
      ...
      <div className="mt-6 mb-4 bg-purple-800 w-4/5 mx-auto p-2 rounded-lg">
        ...
        <div className="flex flex-col">
          ...
          <div onClick={handleProject} className="flex items-center space-x-2 cursor-pointer p-1 hover:bg-white hover:rounded-full hover:text-black transition duration-300">
            <CreateIcon />
