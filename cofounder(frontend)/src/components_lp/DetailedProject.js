...
//     <div className="bg-gradient-to-r from-black to-purple-950 min-h-screen p-10 flex justify-center items-center">
//       <div className="flex w-full h-full">
//         <div className="relative p-6 bg-gradient-to-r from-gray-800 to-gray-900 border-4 border-purple-600 rounded-2xl shadow-lg w-3/5">
...
//             />
//             <div className="ml-4">
//               <h2 className="text-lg font-bold text-white">{projectdetail.username}</h2>
//               <h3 className="text-sm text-gray-400">{projectdetail.designation}</h3>
//             </div>
//           </div>
...
//                     <div key={index} className="ml-5 mb-2 bg-gray-700 p-3 rounded-lg">
...
//               <p className="font-bold text-lg text-white mr-2">
...
//             <Discussion projectId={projectId} /> {/* Include the Chat component */}
//           </div>
//         </div>
//       </div>
//     </div>
